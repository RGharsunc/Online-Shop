                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        ...
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            <h2 class="title text-center">other items</h2>

                            <!-- Wrapper for slides -->
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="/product/details/${productsNotSameId.get(10).id}"><img src="/getImage?filename=${productsNotSameId.get(10).image}"
                                                    alt=""></a>
                                </div>
                                <c:forEach items="${productsNotSameId}" var="product">

                                    <div class="item">

                                        <a href="/product/details/${product.id}"><img src="/getImage?filename=${product.image}" alt=""></a>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <p><b>Condition: </b>${product.condit}</p>
                            <p><b>Brand: </b>${product.brandByBrandId.brandName}</p>
