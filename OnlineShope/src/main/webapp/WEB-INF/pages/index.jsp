        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <%--<div class="categoryEntity-tab">--%>
                        <%--<div class="col-sm-12">--%>
                            <%--<ul class="nav nav-tabs">--%>
                                <%--<li class="active"><a href="#${purposes.get(0).purposeName}"--%>
                                                      <%--data-toggle="tab">${purposes.get(0).purposeName}</a></li>--%>
                                <%--<c:forEach items="${purposes}" var="purpose">--%>


                                    <%--<c:set var="purId" value="${purposes.get(0).id}"/>--%>
                                    <%--<c:if test="${purpose.id!= purId}">--%>


                                        <%--<li><a href="#${purpose.purposeName}"--%>
                                               <%--data-toggle="tab">${purpose.purposeName}</a></li>--%>
                                ...
                                <%--</c:forEach>--%>
                                <%--&lt;%&ndash;<li><a href="#sunglass" data-toggle="tab">Sunglass</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#kids" data-toggle="tab">Kids</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#poloshirt" data-toggle="tab">Polo shirt</a></li>&ndash;%&gt;--%>
                            <%--</ul>--%>
                        <%--</div>--%>
                        <%--<div class="tab-content">--%>

                            <%--<div class="tab-pane fade active in" id="${purposes.get(0).purposeName}">--%>


                                <%--<c:forEach items="${productListByPurpose}" var="producsByPurpose">--%>
                                    <%--<div class="col-sm-3">--%>
                                        <%--<div class="product-image-wrapper">--%>
                                            <%--<div class="single-products">--%>

                                                <%--<div class="productinfo text-center">--%>
                                                        <%--&lt;%&ndash;<img src="/images/home/gallery1.jpg" alt=""/>&ndash;%&gt;--%>
                                                    <%--<h2>$ ${producsByPurpose.price}</h2>--%>
                                                    <%--<p>${producsByPurpose.prodName}</p>--%>
                                                    <%--<a href="#" class="btn btn-default add-to-cart"><i--%>
                                                            <%--class="fa fa-shopping-cart"></i>Add to cart</a>--%>
                                                <%--</div>--%>
                                            <%--</div>--%>
                                ...
                                <%--&lt;%&ndash;<div class="product-image-wrapper">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div class="single-products">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div class="productinfo text-center">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<img src="/images/home/gallery2.jpg" alt=""/>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<h2>$56</h2>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<p>Easy Polo Black Edition</p>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<a href="#" class="btn btn-default add-to-cart"><i&ndash;%&gt;--%>
                                <%--&lt;%&ndash;class="fa fa-shopping-cart"></i>Add to cart</a>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                ...
                                <%--&lt;%&ndash;<div class="single-products">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div class="productinfo text-center">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<img src="/images/home/gallery3.jpg" alt=""/>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<h2>$56</h2>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<p>Easy Polo Black Edition</p>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<a href="#" class="btn btn-default add-to-cart"><i&ndash;%&gt;--%>
                                <%--&lt;%&ndash;class="fa fa-shopping-cart"></i>Add to cart</a>&ndash;%&gt;--%>
                                ...
                                <%--&lt;%&ndash;<div class="single-products">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<div class="productinfo text-center">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<img src="/images/home/gallery4.jpg" alt=""/>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<h2>$56</h2>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<p>Easy Polo Black Edition</p>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<a href="#" class="btn btn-default add-to-cart"><i&ndash;%&gt;--%>
                                <%--&lt;%&ndash;class="fa fa-shopping-cart"></i>Add to cart</a>&ndash;%&gt;--%>
