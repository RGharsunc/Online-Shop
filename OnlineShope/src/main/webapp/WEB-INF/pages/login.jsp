                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            <li><a target="_blank" href="https://web.facebook.com/profile.php?id=100009074155208"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <form action="/login" name="loginForm" method="post">
                        <input type="email" id="email" name="j_username" placeholder="email" />
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="/user/register" comandName="user" role="form" method="post">
